...
include(":apps:android:common:infra:database-match-data-source")
include(":apps:android:common:infra:match-database")
...
include(":apps:android:vanilla:features:history:public")
...
include(":core:features:common:mapper")
include(":core:features:common:response")
